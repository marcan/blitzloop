...
def init_argparser():
    ...
    parser.add_argument(
        '--mpv-visualizer', default="[aid1]asplit=2[ao][a1]; [a1]acompressor=makeup=7:detection=peak:ratio=20:threshold=0.1:release=1000,showcqt=bar_v=8:count=1:attack=1:basefreq=120:csp=bt709:s=128x72:axis=0:fps=60:sono_h=0:bar_g=3:cscheme=0.5|1|0|0|0.5|1,format=pix_fmts=rgb24,split[c1][c2]; [c2]vflip,hflip[c3]; [c1][c3]blend=all_mode=addition[vo]",
